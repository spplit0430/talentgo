...
class CostosPregunta2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_costos_pregunta2)
    ...
    private fun guardarRespuestaYAvanzar(respuesta: String) {
        ...
        firestore.collection("costos_respuestas")
            ...
            .addOnSuccessListener {
                // Redirigir a la siguiente pregunta (CostosPregunta3Activity)
