...
class CostosPregunta6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_costos_pregunta6)
    ...
    private fun guardarRespuestaYAvanzar(respuesta: String) {
        ...
        firestore.collection("costos_respuestas")
            ...
            .addOnSuccessListener {
                val intent = Intent(this, ResultadoCostoActivity::class.java)
